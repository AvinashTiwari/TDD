package learn.avinash.tdd.order.dao.impl;
...
import learn.avinash.tdd.order.dao.impl.OrderDaoJpaImpl;
...
public class OrderDaoJpaImplTest_Demo3 extends BaseDBUnitTestForJPADao {
	//learn.avinash.tdd.order.dao.impl
	private final static class DataFiles {
		private final static String XML_DATA_SET = 
				"learn/avinash/tdd/order/dao/impl/OrderDaoJpaImplTest_XMLDataSet.xml";
		private final static String FLAT_XML_DATA_SET = 
				"learn/avinash/tdd/order/dao/impl/OrderDaoJpaImplTest_FlatXMLDataSet.xml";
		private final static String XLS_DATA_SET = 
				"learn/avinash/tdd/order/dao/impl/OrderDaoJpaImplTest_XlsDataSet.xls";
	}
